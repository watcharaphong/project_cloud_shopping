     ...
     <div class="row">
       <div class="col-md-12">
         <div class="cart-view-area">
			 <h3><center><strong>ออเดอร์ของฉัน</strong></center></h3>
...
<?php
	...
	$str = "SELECT * FROM `orders` WHERE `orders`.`muser`='{$_COOKIE['muser']}'";
...
?>
      <tr>
		...
		<td><a  href="JavaScript:window.location='m_order_detail.php?ordersid=<?=$data['ordersid'];?>',
                   '',400,320" >รายละเอียด</a></td>
        <td><?php echo $data['fname']." ".$data['lname'];?></td>
        <td><?php echo $data['address'];?></td>
		<td><?php echo (number_format($data['pricetotal'],2));?></td>
		<td><?php echo $data['time'];?></td>
		<td><?php echo $data['status'];?></td>		  
		  <td>
			  
			<center><a class="btn btn-danger" href="JavaScript:if(confirm('ยกเลิกออเดอร๋นี้ ?')==true)
                   JavaScript:window.location='orders_delete.php?ordersid=<?=$data['ordersid'];?>',
                   '',400,320" role="button">ยกเลิก</a><br></center>
			</td>
    </tr>
<?php $num++;
}
