            ...
            <div class="aa-header-top-area">
              ...
              <div class="aa-header-top-right">
                <ul class="aa-head-top-nav-right">
				 ...
				 // echo "<li><a href='system/login.php'>ADMIN</a></li>";
                 } ?>
      ...
      <div id="sequence" class="seq">
        <div class="seq-screen">
          <ul class="seq-canvas">
            <!-- single slide item -->
            <li>
              <iframe width="100%" height="100%" src="https://www.youtube.com/embed/RkC0l4iekYo" frameborder="0" gesture="media" allowfullscreen></iframe>
				<div class="seq-title">
                <h2 data-seq>PlayStation</h2>
              </div>
            </li>
            <!-- single slide item -->
            <li>
              <iframe width="100%" height="100%" src="https://www.youtube.com/embed/dD62_vBpuJ8" frameborder="0" gesture="media" allowfullscreen></iframe>
				<div class="seq-title">
                <h2 data-seq>Joystick</h2>
              </div>
            </li>
            <!-- single slide item -->
            <li>
              <iframe width="100%" height="100%" src="https://www.youtube.com/embed/0tUqIHwHDEc" frameborder="0" gesture="media" allowfullscreen></iframe>
				<div class="seq-title">
                <h2 data-seq>Xbox</h2>
              </div>
            </li>
...
<figcaption>
<h5 class="aa-product-title"><a href="#"><?php echo $product_array[$key]["name"]; ?></a></h5>
<?php 
if($product_array[$key]["sale"] >= 1){
$sale = ($product_array[$key]["sale"]/100) * $product_array[$key]["price"] ;
$saletotal = $product_array[$key]["price"] - $sale;
echo '<span class="aa-product-price">฿<del>'.number_format($product_array[$key]["price"],2).
'</del></span>';
echo '<span class="aa-product-price"> ฿'.number_format($saletotal,2).'</span>';
}else{
          ...
          <div class="aa-support-area">
            ...
            <div class="col-md-4 col-sm-4 col-xs-12">
              <div class="aa-support-single">
                ...
                <h4>ช่วยเหลือเบอร์ +66 65265 1390</h4>
              </div>
            </div>
          </div>
        </div>
