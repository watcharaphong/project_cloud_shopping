            ...
            <div class="aa-header-top-area">
              ...
              <div class="aa-header-top-right">
                <ul class="aa-head-top-nav-right">
                  ...
                  echo "<li><a href='profile.php'>"."Member: ".ucfirst($_COOKIE["muser"])."</a></li>";
                } ?>
   ...
   <div class="container">
    ...
    <div class="row">
        <div class="col-md-3 border-right">
			...
			<label name="muser"><?php echo "Member: ".$data['muser'];?></label>
            <div class="d-flex flex-column align-items-center text-center p-3 py-5"><img src="<?php echo $data['image'];?>" width="150" height="200"><br>
		...
		<input type="text" class="form-control" name="fname" placeholder="surname" value="<?php echo $data["fname"]; ?>"></div>
                    <div class="col-md-6"><label class="labels">Surname</label><input type="text" class="form-control" name="lname" value="<?php echo $data["lname"]; ?>" placeholder="surname"></div>
                </div>
                <div class="row mt-3">
                    <div class="col-md-12"><label class="labels">PhoneNumber</label><input type="text" class="form-control" name="tel" placeholder="enter phone number" value="<?php echo $data["tel"]; ?>"></div>
					
                    <div class="col-md-12"><label class="labels">Address</label><input type="text" class="form-control" placeholder="enter address" name="maddress" value="<?php echo $data["maddress"]; ?>"></div>
					
                    <div class="col-md-12"><label class="labels">Email </label><input type="text" class="form-control" placeholder="enter email id" name="memail" value="<?php echo $data["memail"]; ?>"></div>


					<div class="form-group">
			 <label class="col-md-4 control-label" for="submit"></label>
			 <div class="col-md-4">
			<a class="btn btn-danger" href="JavaScript:if(confirm('ลบออเดอร๋นี้ ?')==true)
                   JavaScript:window.location='edit_profile.php?muser=<?=$data['muser'];?>',
                   '',400,320" role="button">ลบ</a>
			 </div>
				</div>
