...
<!-- Breadcrumbs -->
	<ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">ออเดอร์สินค้า</li>
        </ol>
<!-- Example Tables Card -->
<div class="card mb-3">
...
?>
      <tr>
		...
		<td><a  href="JavaScript:window.location='orders_detail.php?ordersid=<?=$data['ordersid'];?>',
	...
	<td>
	  <form method="post" action="orders_submit.php?ordersid=<?=$data['ordersid'];?>" >
	  ...
	  <option value="ยังไม่ได้ชำระเงิน">ยังไม่ได้ชำระเงิน</option>
		...
		<button type="submit" class="btn btn-success btn-sm" >บันทึก</button>
		  ...
		  <td>
			...
			<center><a class="btn btn-danger" href="JavaScript:if(confirm('ลบออเดอร๋นี้ ?')==true)
