...
<html lang="en">
  ...
  <head>
    ...
    <!-- Plugin CSS -->
    <link href="../system/vendor/datatables/dataTables.bootstrap4.css" rel="stylesheet">

    <!-- Custom styles for this template -->
    <link href="../system/css/sb-admin.css" rel="stylesheet">
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
          <li class="nav-item" data-toggle="tooltip" data-placement="right" title="เพิ่มสินค้า">
            <a class="nav-link" href="../system/index.php">
          ...
          <li class="nav-item" data-toggle="tooltip" data-placement="right" title="เพิ่มสินค้า">
            <a class="nav-link" href="../system/add_product.php">
...
?>
	...
	<td>
	  <form method="post" action="../Dashboard/edit_member.php?muser=<?=$data['muser'];?>">
...
<!-- /.container-fluid -->
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-footer">
			  <a class="btn btn-primary" href="../system/logout.php">Yes</a>
    ...
    <script src="../system/vendor/popper/popper.min.js"></script>
    ...
    <script src="../system/vendor/chart.js/Chart.min.js"></script>
    <script src="../system/vendor/datatables/jquery.dataTables.js"></script>
    <script src="../system/vendor/datatables/dataTables.bootstrap4.js"></script>

    <!-- Custom scripts for this template -->
    <script src="../system/js/sb-admin.min.js"></script>
