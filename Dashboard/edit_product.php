...
<div class="form-group">
	...
	$dt_product = mysqli_fetch_array($rs); 
     ...
     <input id="name" name="code" type="text" placeholder="LM520" 
            class="form-control input-md" required="" value="<?php echo $dt_product["code"]; ?>">
     <span class="help-block">กรอกรหัสสินค้า</span>
	 </div>
</div>
<!-- Text input-->
...
<!-- Text input-->
     ...
     <input id="name" name="price" type="text" placeholder="1000" 
            class="form-control input-md" required="" value="<?php echo $dt_product["price"]; ?>">
     ...
     <input id="name" name="unit" type="text" placeholder="1000" 
            class="form-control input-md" required="" value="<?php echo $dt_product["unit"]; ?>">
     ...
     <input id="name" name="sale" type="text" placeholder="1000" 
            class="form-control input-md" required="" value="<?php echo $dt_product["sale"]; ?>">
